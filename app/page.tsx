    ...
    <main className="relative h-screen w-full overflow-hidden bg-background">
      ...
      >
        ...
        >
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-foreground/15 backdrop-blur-md transition-all duration-300 hover:scale-110 hover:bg-foreground/25 md:h-10 md:w-10">
            <span className="font-sans text-lg font-bold text-foreground md:text-xl">S</span>
          </div>
          <div className="flex flex-col">
            <span className="font-sans text-base font-semibold leading-none tracking-tight text-foreground md:text-lg">
              SmartCore
            </span>
            <span className="font-sans text-[10px] font-light leading-none tracking-tight text-foreground/70 md:text-xs">
              Technologies Ltd
            </span>
          </div>
        </button>
      ...
      <div
        ...
        style={{
          ...
          paddingTop: `calc(var(--header-height, 0px) + env(safe-area-inset-top))`,
      ...
      >
        <section className="flex min-h-screen w-screen shrink-0 flex-col justify-center px-6 py-20 md:px-12 md:py-24">
          ...
          <div className="absolute bottom-20 left-1/2 hidden -translate-x-1/2 animate-in fade-in duration-1000 delay-500 md:bottom-8 md:block">
